...
class Gerardas221Template(BaseTemplate):
    """Template for GERARDAS221 - Emitir DAS."""
...
# Register template
TemplateRegistry.register("PERTMEI", "GERARDAS221", Gerardas221Template)
