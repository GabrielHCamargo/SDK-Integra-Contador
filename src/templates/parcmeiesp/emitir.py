...
class Gerardas211Template(BaseTemplate):
    """Template for GERARDAS211 - Emitir DAS."""
    ...
    def validate(self, dados: dict[str, Any]) -> dict[str, Any]:
        ...
        Args:
            dados: Input data dictionary with required field:
                - parcelaParaEmitir: int (parcela to emit in format YYYYMM, e.g., 202107)
        ...
        if parcela < 190000 or parcela > 210012:
            raise ValidationError("Field 'parcelaParaEmitir' must be in YYYYMM format (e.g., 202107)")
...
# Register template
TemplateRegistry.register("PARCMEI-ESP", "GERARDAS211", Gerardas211Template)
