"""E-PROCESSO - Consultar templates."""
...
class ConsProcPorInter271Template(BaseTemplate):
    """Template for CONSPROCPORINTER271 - Consultar Processos por Interessado."""
    ...
    def _serialize_dados(self, dados: dict[str, Any]) -> str:
        ...
        Returns:
            JSON string "{}" for this service (empty object)
        """
        return "{}"


# Register template
TemplateRegistry.register("EPROCESSO", "CONSPROCPORINTER271", ConsProcPorInter271Template)
