...
class Gerardas201Template(BaseTemplate):
    """Template for GERARDAS201 - Emitir DAS."""
...
# Register template
TemplateRegistry.register("PARCMEI", "GERARDAS201", Gerardas201Template)
