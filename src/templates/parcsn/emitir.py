...
class Gerardas161Template(BaseTemplate):
    """Template for GERARDAS161 - Emitir DAS."""
...
# Register template
TemplateRegistry.register("PARCSN", "GERARDAS161", Gerardas161Template)
